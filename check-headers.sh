...
exclude_pattern='node_modules|.venv|organization-service.yaml|project-service.yaml|acs-service.yaml|user-service.yaml|api.*.compiled.yaml|.vendor-new|.pytest_cache|.idea|.husky/_/*|frontend/dist|backend/dis|.gitignore'
