...
@Component({
  selector: 'lfx-new-contributors',
  templateUrl: './new-contributors.component.html',
  styleUrls: ['./new-contributors.component.scss']
})
export class NewContributorsComponent implements OnInit, AfterViewInit {
